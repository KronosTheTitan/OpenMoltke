...
bool ApplicationClass::Initialize(int screenWidth, int screenHeight, HWND hwnd)
{
    ...
    strcpy_s(modelFilename, "OpenMoltke/models/ground.txt");
    strcpy_s(textureFilename, "OpenMoltke/textures/ground01.tga");
    ...
    strcpy_s(modelFilename, "OpenMoltke/models/wall.txt");
    strcpy_s(textureFilename, "OpenMoltke/textures/wall01.tga");
    ...
    strcpy_s(modelFilename, "OpenMoltke/models/bath.txt");
    strcpy_s(textureFilename, "OpenMoltke/textures/marble01.tga");
    ...
    strcpy_s(modelFilename, "OpenMoltke/models/water.txt");
    strcpy_s(textureFilename, "OpenMoltke/textures/water01.tga");
	...
	if(!result)
	{
		MessageBox(hwnd, "Could not initialize the refraction render texture object.", "Error", MB_OK);
		return false;
	}
	...
	if(!result)
	{
		MessageBox(hwnd, "Could not initialize the reflection render texture object.", "Error", MB_OK);
		return false;
	}
